...
public class NMP
{
	...
	public static class PLAYER
	{
		...
		{
			return Catalyst.host.canSee(c, p);
		}
		...
		{
			return Catalyst.host.canSee(l, p);
		}
		...
		{
			return Catalyst.host.getSettings(p);
		}
	}
	...
	public static class MESSAGE
	{
		...
		{
			Catalyst.host.sendAdvancement(player, type, item, msg);
		}
		...
		{
			new PacketBuffer().q(Catalyst.host.packetActionBarMessage(msg)).flush(p);
		}
		...
		{
			new PacketBuffer().q(Catalyst.host.packetResetTitle()).flush(p);
		}
		...
		{
			new PacketBuffer().q(Catalyst.host.packetTitleMessage(title)).q(Catalyst.host.packetSubtitleMessage(subtitle)).q(Catalyst.host.packetTimes(in, stay, out)).flush(p);
		}
	}
