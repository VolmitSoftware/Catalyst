...
public final class ChunkSection implements Cloneable
{
	...
	{
		return IDUtils.getId(getType(x, y, z));
	}

	public int getTypeData(int x, int y, int z)
	{
		return IDUtils.getData(getType(x, y, z));
	}
	...
	public int writeToBuf(ByteArrayOutputStream buf, boolean skylight) throws IllegalStateException
	{
		ByteBuf b = Unpooled.buffer();
		b.writerIndex(0);
		writeToBuf(b, skylight);
		int w = b.writableBytes();
		buf.write(b.array(), 0, w);
		return w;
	}
